...
export default function Electrical() {
  const services = [
    {
      ...
      features: ["Ceiling fixtures", "Recessed lighting", "Outdoor lighting"]
    },
    {
      icon: Zap,
      title: "Electrical Repairs",
      description: "Safe and reliable electrical repair services.",
      features: ["Outlet repairs", "Panel upgrades"]
    },
    {
      icon: Home,
      title: "Residential Wiring",
      description: "Complete wiring solutions for homes and apartments.",
      features: ["New installations", "Rewiring projects", "Code compliance"]
    },
    {
      icon: Building2,
      title: "Commercial Electrical",
      description: "Professional electrical services for businesses.",
      features: ["Office wiring", "Emergency lighting"]
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Fully licensed and certified electrical professionals."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with BuildWell Construction's professional electrical services in Toronto and Ontario. 
                We deliver safe, reliable electrical solutions with attention to every detail.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-blue-200/20 to-blue-300/30 rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl flex items-center justify-center">
                <div className="text-center text-blue-100">
                  ...
                  <p className="text-lg font-medium">Professional Electrical Image</p>
                  <p className="text-sm opacity-75">Replace with actual electrical photo</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                content: "Excellent electrical work! The team upgraded our entire panel and installed new outlets throughout the house. Professional, safe, and completed on time.",
                rating: 5,
                image: "MB"
              },
              {
                ...
                content: "BuildWell Construction handled all our office electrical needs. From lighting to emergency systems, everything was done perfectly.",
                rating: 5,
                image: "CW"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Need Safe Electrical Work?
            </h2>
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across Toronto and Ontario. Get your free consultation today and experience the difference professional electrical work makes.
            </p>
          </div>
