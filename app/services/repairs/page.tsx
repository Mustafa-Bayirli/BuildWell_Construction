...
export default function DrywallRepairs() {
  const services = [
    {
      icon: Hammer,
      title: "Hole Repairs",
      description: "Professional repair of holes and damage in drywall.",
      features: ["Small nail holes", "Large holes", "Seamless patches"]
    },
    {
      icon: Wrench,
      title: "Crack Repairs",
      description: "Expert repair of cracks and joint issues.",
      features: ["Settlement cracks", "Joint repairs", "Corner bead fixes"]
    },
    {
      icon: Home,
      title: "Texture Matching",
      description: "Perfect texture matching for invisible repairs.",
      features: ["Orange peel", "Knockdown texture", "Smooth finishes"]
    },
    {
      icon: Building2,
      title: "Water Damage Repair",
      description: "Complete restoration of water-damaged drywall.",
      features: ["Moisture assessment", "Mold prevention", "Full replacement"]
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Expert texture and paint matching for seamless repairs."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Expert Drywall Repair Services
              </h1>
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with BuildWell Construction's professional drywall repair services in Toronto and Ontario. 
                We deliver seamless repairs with attention to every detail.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-blue-200/20 to-blue-300/30 rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl flex items-center justify-center">
                <div className="text-center text-blue-100">
                  ...
                  <p className="text-lg font-medium">Professional Drywall Image</p>
                  <p className="text-sm opacity-75">Replace with actual drywall photo</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Professional drywall repair solutions for residential and commercial properties.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              {
                name: "Kevin Murphy",
                role: "Long Island Homeowner",
                content: "Amazing drywall repair work! They fixed holes from our renovation and you can't even tell where the damage was. Perfect texture matching and professional service.",
                rating: 5,
                image: "KM"
              },
              {
                name: "Jessica Chang",
                role: "Manhattan Property Manager",
                content: "BuildWell Construction handles all our drywall repairs for multiple properties. Fast, reliable, and the quality is always excellent. Highly recommend their services!",
                rating: 5,
                image: "JC"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Need Seamless Drywall Repairs?
            </h2>
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across Toronto and Ontario. Get your free consultation today and experience the difference professional drywall repair makes.
            </p>
          </div>
