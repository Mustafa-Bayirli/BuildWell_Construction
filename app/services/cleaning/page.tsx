  ...
  const services = [
    {
      icon: Home,
      title: "Residential",
      description: "Complete home cleaning for comfortable living.",
      features: ["Kitchen & bathrooms", "Bedrooms & living areas", "Regular maintenance"]
    },
    {
      icon: Building2,
      title: "Commercial",
    ...
    },
    {
      icon: Droplets,
      title: "Deep Cleaning",
      description: "Intensive cleaning for complete restoration.",
      features: ["Post-construction", "Spring cleaning", "Sanitization services"]
    },
    {
      icon: Zap,
      title: "Move In/Out",
      description: "Comprehensive cleaning for transitions.",
      features: ["Move-in preparation", "Move-out cleaning", "Property handover"]
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with BuildWell Construction's professional cleaning services in Toronto and Ontario. 
                We deliver spotless results with attention to every detail.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-blue-200/20 to-blue-300/30 rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl flex items-center justify-center">
                <div className="text-center text-blue-100">
                  ...
                  <p className="text-lg font-medium">Professional Cleaning Image</p>
                  <p className="text-sm opacity-75">Replace with actual cleaning photo</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                content: "Outstanding service! The team was professional, thorough, and left our home absolutely spotless. I've been using their services for over a year now.",
                rating: 5,
                image: "SJ"
              },
              {
                name: "Mike Chen",
                role: "Brooklyn Office Manager",
                content: "BuildWell Construction has been cleaning our office for 2 years. Consistent quality, reliable service, and great communication every time.",
                rating: 5,
                image: "MC"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across Toronto and Ontario. Get your free consultation today and experience the difference professional cleaning makes.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button 
              ...
              variant="outline" 
              onClick={handlePhoneCall}
              className="border-2 border-white dark:bg-white text-blue-700 hover:bg-blue-700 hover:text-white px-10 py-4 text-lg font-semibold rounded-xl transition-all duration-300"
            >
              Schedule Service
            </Button>
          </div>
