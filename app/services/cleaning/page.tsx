          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with Westside Renovation Inc's professional cleaning services in New York. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                content: "Westside Renovation Inc has been cleaning our office for 2 years. Consistent quality, reliable service, and great communication every time.",
                rating: 5,
                image: "MC"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across New York. Get your free consultation today and experience the difference professional cleaning makes.
            </p>
          </div>
