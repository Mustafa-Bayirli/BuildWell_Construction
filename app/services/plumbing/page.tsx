...
export default function Plumbing() {
  const services = [
    {
      ...
      features: ["Leak repairs", "Pipe replacement", "Emergency fixes"]
    },
    {
      icon: Home,
      title: "Bathroom Plumbing",
      description: "Complete bathroom plumbing installation and repairs.",
      features: ["Toilet installation", "Sink repairs", "Shower plumbing"]
    },
    {
      icon: Building2,
      title: "Kitchen Plumbing",
      description: "Expert kitchen plumbing solutions and installations.",
      features: ["Faucet installation", "Garbage disposal", "Dishwasher hookup"]
    },
    {
      icon: Wrench,
      title: "Drain Cleaning",
      description: "Professional drain cleaning and maintenance services.",
      features: ["Clog removal", "Drain snaking", "Preventive maintenance"]
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Fully licensed and certified plumbing professionals."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with BuildWell Construction's professional plumbing services in Toronto and Ontario. 
                We deliver reliable plumbing solutions with attention to every detail.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-blue-200/20 to-blue-300/30 rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl flex items-center justify-center">
                <div className="text-center text-blue-100">
                  ...
                  <p className="text-lg font-medium">Professional Plumbing Image</p>
                  <p className="text-sm opacity-75">Replace with actual plumbing photo</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                content: "Outstanding plumbing service! Fixed our kitchen leak quickly and professionally. The team was clean, efficient, and the pricing was very fair. Highly recommend!",
                rating: 5,
                image: "TR"
              },
              {
                ...
                content: "BuildWell Construction completely renovated our bathroom plumbing. Great communication and quality work.",
                rating: 5,
                image: "AL"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Need Reliable Plumbing Work?
            </h2>
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across Toronto and Ontario. Get your free consultation today and experience the difference professional plumbing makes.
            </p>
          </div>
