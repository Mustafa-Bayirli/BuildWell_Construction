          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your space with BuildWell Construction's professional installation services in Toronto and Ontario. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                content: "BuildWell Construction installed all our office fixtures and security systems. Professional work, on time, and great attention to detail. Highly recommend!",
                rating: 5,
                image: "MR"
              }
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Join hundreds of satisfied customers across Toronto and Ontario. Get your free consultation today and experience the difference professional installation makes.
            </p>
          </div>
